...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: OMT_Start(void)
;  FUNCTION NAME: OMT_Stop(void)
;
;  FUNCTION NAME: OMT_Switch(void)
;
;  DESCRIPTION: ( Switch )
;     Turn LED on or off     
;
...
IF(1)                                            ; Active High Digit Drive
   or   [Port_0_Data_SHADE],OMT_PinMask
ELSE                                             ; Active Low Digit Drive
   and  [Port_0_Data_SHADE],~OMT_PinMask
ENDIF
   jmp  .Switch_LED
...
_OMT_Invert:
 OMT_Invert:
   ...
   xor  [Port_0_Data_SHADE],OMT_PinMask
   mov  A,[Port_0_Data_SHADE]
   mov  reg[OMT_PortDR],A
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: OMT_GetState(void)
;
;  DESCRIPTION:
;     Get state of LED
;
...
ENDIF
   and   A,OMT_PinMask                 ; Mask off the trash
