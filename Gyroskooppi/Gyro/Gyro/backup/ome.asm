...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: OME_Start(void)
;  FUNCTION NAME: OME_Stop(void)
;
;  FUNCTION NAME: OME_Switch(void)
;
;  DESCRIPTION: ( Switch )
;     Turn LED on or off     
;
...
IF(1)                                            ; Active High Digit Drive
   or   [Port_0_Data_SHADE],OME_PinMask
ELSE                                             ; Active Low Digit Drive
   and  [Port_0_Data_SHADE],~OME_PinMask
ENDIF
   jmp  .Switch_LED
...
_OME_Invert:
 OME_Invert:
   ...
   xor  [Port_0_Data_SHADE],OME_PinMask
   mov  A,[Port_0_Data_SHADE]
   mov  reg[OME_PortDR],A
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: OME_GetState(void)
;
;  DESCRIPTION:
;     Get state of LED
;
...
ENDIF
   and   A,OME_PinMask                 ; Mask off the trash
