...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: VMT_Start(void)
;  FUNCTION NAME: VMT_Stop(void)
;
;  FUNCTION NAME: VMT_Switch(void)
;
;  DESCRIPTION: ( Switch )
;     Turn LED on or off     
;
...
IF(1)                                            ; Active High Digit Drive
   or   [Port_0_Data_SHADE],VMT_PinMask
ELSE                                             ; Active Low Digit Drive
   and  [Port_0_Data_SHADE],~VMT_PinMask
ENDIF
   jmp  .Switch_LED
...
_VMT_Invert:
 VMT_Invert:
   ...
   xor  [Port_0_Data_SHADE],VMT_PinMask
   mov  A,[Port_0_Data_SHADE]
   mov  reg[VMT_PortDR],A
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: VMT_GetState(void)
;
;  DESCRIPTION:
;     Get state of LED
;
...
ENDIF
   and   A,VMT_PinMask                 ; Mask off the trash
