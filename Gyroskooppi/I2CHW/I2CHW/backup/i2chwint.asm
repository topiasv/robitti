...
IF (I2CHW_CY8C22x45)
   M8C_SetBank1
   tst   reg[I2CHW_ADDR], I2CHW_HW_ADDR_EN
   jnz   HwAddrRecEnabled
   M8C_SetBank0
ENDIF
IF (I2CHW_AUTO_ADDR_CHECK ^ 1)
...
ENDIF
IF (I2CHW_CY8C22x45)
   jmp   I2C_AckAddr_TXdata
HwAddrRecEnabled:
   M8C_SetBank0
ENDIF
IF (I2CHW_AUTO_ADDR_CHECK | I2CHW_CY8C22x45)
   or    [I2CHW_RsrcStatus], I2CHW_ISR_ACTIVE
   tst   reg[I2CHW_DR], I2CHW_RW
   jz    I2C_AckAddr_RXdata
ENDIF
IF (I2CHW_CY8C22x45)
I2C_AckAddr_TXdata:
ENDIF
...
;; clear the mask bit since it's is serviced manually.
    jz ExitISR
    M8C_ClearIntFlag INT_CLR3, 0x01                                ;clear the I2C interrupt
ENDIF
