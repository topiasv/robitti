...
IF (I2CHW_MUM_SEL & (I2CHW_SLAVE | I2CHW_MMS))
 IF (I2CHW_CY8C22x45)
export    I2CHW_EnableHWAddrCheck
export   _I2CHW_EnableHWAddrCheck
export    I2CHW_DisableHWAddrCheck
export   _I2CHW_DisableHWAddrCheck
 ENDIF
ENDIF
...
IF (I2CHW_MUM_SEL & (I2CHW_SLAVE | I2CHW_MMS))
 IF (I2CHW_CY8C22x45)
   M8C_SetBank1
   mov   reg[I2CHW_ADDR], I2CHW_SLAVE_ADDR;I2CHW_HW_ADDR_EN
   M8C_SetBank0
 ENDIF
ENDIF
...
_I2CHW_EnableInt:
    ...
    M8C_ClearIntFlag INT_CLR3, I2CHW_INT_MASK
ResumeIntEntry:
...
IF (I2CHW_MUM_SEL & (I2CHW_SLAVE | I2CHW_MMS))
 ...
 .SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: void  I2CHW_EnableHWAddrCheck(void)
;
;  DESCRIPTION:
...
_I2CHW_EnableHWAddrCheck:
   RAM_PROLOGUE RAM_USE_CLASS_1
   M8C_SetBank1
   or    reg[I2CHW_ADDR], I2CHW_HW_ADDR_EN
   M8C_SetBank0
   RAM_EPILOGUE RAM_USE_CLASS_1
   ret
.ENDSECTION
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: void  I2CHW_DisableHWAddrCheck(void)
;
;  DESCRIPTION:
...
_I2CHW_DisableHWAddrCheck:
   RAM_PROLOGUE RAM_USE_CLASS_1
   M8C_SetBank1
   and   reg[I2CHW_ADDR], ~I2CHW_HW_ADDR_EN
   M8C_SetBank0
   RAM_EPILOGUE RAM_USE_CLASS_1
   ret
.ENDSECTION
