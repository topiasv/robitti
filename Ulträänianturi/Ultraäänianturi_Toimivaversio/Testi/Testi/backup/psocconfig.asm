...
export LoadConfig_testi
export _LoadConfig_testi
...
_LoadConfigInit:
 LoadConfigInit:
	...
	mov		[Port_1_DriveMode_0_SHADE], 4h
	mov		[Port_1_DriveMode_1_SHADE], fbh
	mov		[Port_1_DriveMode_2_SHADE], f0h
	mov		[Port_2_Data_SHADE], 0h
	mov		[Port_2_DriveMode_0_SHADE], 7fh
	mov		[Port_2_DriveMode_1_SHADE], 80h

	lcall	LoadConfig_testi
	lcall	LoadConfigTBL_testi_Ordered
...
;---------------------------------------------------------------------------
; Load Configuration testi
;
;    Load configuration registers for testi.
...
_LoadConfig_testi:
 LoadConfig_testi:
    ...
    asr     a                       ; Store in carry flag
                                    ; Load bank 0 table:
    mov     A, >LoadConfigTBL_testi_Bank0
    mov     X, <LoadConfigTBL_testi_Bank0
    lcall   LoadConfig              ; Load the bank 0 values

    mov     a, 1                    ; Specify bank 1
    asr     a                       ; Store in carry flag
                                    ; Load bank 1 table:
    mov     A, >LoadConfigTBL_testi_Bank1
    mov     X, <LoadConfigTBL_testi_Bank1
