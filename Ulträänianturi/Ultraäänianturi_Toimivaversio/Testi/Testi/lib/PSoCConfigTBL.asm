...
export LoadConfigTBL_testi_Bank1
export LoadConfigTBL_testi_Bank0
export LoadConfigTBL_testi_Ordered
AREA lit(rom, rel)
LoadConfigTBL_testi_Bank0:
;  Instance name Echo, User Module Counter16
;       Instance name Echo, Block Name CNTR16_LSB(DBB00)
	db		23h, 00h		;Echo_CONTROL_LSB_REG(DBB00CR0)
	db		21h, 00h		;Echo_PERIOD_LSB_REG(DBB00DR1)
	db		22h, 00h		;Echo_COMPARE_LSB_REG(DBB00DR2)
;       Instance name Echo, Block Name CNTR16_MSB(DBB01)
	db		27h, 00h		;Echo_CONTROL_MSB_REG(DBB01CR0)
	db		25h, 00h		;Echo_PERIOD_MSB_REG(DBB01DR1)
	db		26h, 00h		;Echo_COMPARE_MSB_REG(DBB01DR2)
;  Instance name GYRO, User Module I2Cm
;  Instance name LCD, User Module LCD
;  Instance name OME, User Module LED
;  Instance name OMT, User Module LED
;  Instance name TRIGG, User Module LED
;  Instance name VME, User Module LED
;  Instance name VMT, User Module LED
;  Global Register values Bank 0
	...
	db		b0h, 80h		; Row_0_InputMux register (RDI0RI)
	...
	db		ffh
LoadConfigTBL_testi_Bank1:
;  Instance name Echo, User Module Counter16
;       Instance name Echo, Block Name CNTR16_LSB(DBB00)
	db		20h, 01h		;Echo_FUNC_LSB_REG(DBB00FN)
	db		21h, 11h		;Echo_INPUT_LSB_REG(DBB00IN)
	db		22h, 40h		;Echo_OUTPUT_LSB_REG(DBB00OU)
;       Instance name Echo, Block Name CNTR16_MSB(DBB01)
	db		24h, 21h		;Echo_FUNC_MSB_REG(DBB01FN)
	db		25h, 31h		;Echo_INPUT_MSB_REG(DBB01IN)
	db		26h, 40h		;Echo_OUTPUT_MSB_REG(DBB01OU)
;  Instance name GYRO, User Module I2Cm
;  Instance name LCD, User Module LCD
;  Instance name OME, User Module LED
;  Instance name OMT, User Module LED
...
LoadConfigTBL_testi_Ordered:
;  Ordered Global Register values
	M8C_SetBank0
	mov	reg[00h], 00h		; Port_0_Data register (PRT0DR)
	M8C_SetBank1
	mov	reg[00h], c8h		; Port_0_DriveMode_0 register (PRT0DM0)
	mov	reg[01h], 37h		; Port_0_DriveMode_1 register (PRT0DM1)
	M8C_SetBank0
	mov	reg[03h], 37h		; Port_0_DriveMode_2 register (PRT0DM2)
