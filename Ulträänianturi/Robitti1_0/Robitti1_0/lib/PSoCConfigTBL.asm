...
export LoadConfigTBL_robitti1_0_Bank1
export LoadConfigTBL_robitti1_0_Bank0
export LoadConfigTBL_robitti1_0_Ordered
AREA lit(rom, rel)
LoadConfigTBL_robitti1_0_Bank0:
...
;  Global Register values Bank 0
	...
	db		b0h, 32h		; Row_0_InputMux register (RDI0RI)
	...
	db		ffh
LoadConfigTBL_robitti1_0_Bank1:
;  Instance name GYRO, User Module I2Cm
;  Instance name LCD, User Module LCD
;  Instance name OME, User Module LED
;  Instance name OMT, User Module LED
...
LoadConfigTBL_robitti1_0_Ordered:
;  Ordered Global Register values
	M8C_SetBank0
	mov	reg[00h], 00h		; Port_0_Data register (PRT0DR)
	M8C_SetBank1
	mov	reg[00h], cch		; Port_0_DriveMode_0 register (PRT0DM0)
	mov	reg[01h], 33h		; Port_0_DriveMode_1 register (PRT0DM1)
	M8C_SetBank0
	mov	reg[03h], 33h		; Port_0_DriveMode_2 register (PRT0DM2)
