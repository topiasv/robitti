...
#define POWER_SETTING          0x8     //Power Setting [ Vcc / SysClk freq ] 0x10 = 5.0V / 24MHz
										//				0x08 = 3.3V / 24MHz
										//				0x09 = 3.3V / 12MHz
...
#define PORT_0_DRIVE_0         0xcc    //Port 0 drive mode 0 register (PRT0DM0)
#define PORT_0_DRIVE_1         0x33    //Port 0 drive mode 1 register (PRT0DM1)
#define PORT_0_DRIVE_2         0x33    //Port 0 drive mode 1 register (PRT0DM2)
