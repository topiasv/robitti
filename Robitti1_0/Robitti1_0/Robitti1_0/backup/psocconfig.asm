...
export LoadConfig_robitti1_0
export _LoadConfig_robitti1_0
...
_LoadConfigInit:
 LoadConfigInit:
	...
	mov		[Port_1_DriveMode_0_SHADE], 0h
	mov		[Port_1_DriveMode_1_SHADE], ffh
	mov		[Port_1_DriveMode_2_SHADE], fch
	mov		[Port_2_Data_SHADE], 0h
	mov		[Port_2_DriveMode_0_SHADE], 7fh
	mov		[Port_2_DriveMode_1_SHADE], 80h

	lcall	LoadConfig_robitti1_0
	lcall	LoadConfigTBL_robitti1_0_Ordered
...
;---------------------------------------------------------------------------
; Load Configuration robitti1_0
;
;    Load configuration registers for robitti1_0.
...
;               CUR_PP
;
_LoadConfig_robitti1_0:
 LoadConfig_robitti1_0:
    RAM_PROLOGUE RAM_USE_CLASS_4
    ...
    asr     a                       ; Store in carry flag
                                    ; Load bank 0 table:
    mov     A, >LoadConfigTBL_robitti1_0_Bank0
    mov     X, <LoadConfigTBL_robitti1_0_Bank0
    lcall   LoadConfig              ; Load the bank 0 values

    mov     a, 1                    ; Specify bank 1
    asr     a                       ; Store in carry flag
                                    ; Load bank 1 table:
    mov     A, >LoadConfigTBL_robitti1_0_Bank1
    mov     X, <LoadConfigTBL_robitti1_0_Bank1
